...
-- ============================================
-- 加载 ESP 模块 (你可以改成自己的 raw 链接或本地路径)
-- ============================================
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/sametexe001/juanitahaxx/refs/heads/main/ESP.lua"))()
-- 如果是本地文件用这个:
-- local ESP = loadstring(readfile("juanitahaxx/ESP.lua"))()
...
do
    ...
    do -- Window
        ...
        local PlayersPage = Window:Page({Name = "players"}) -- 修复: 原代码重复命名了 VisualsPage
    ...
    -- ============================================
    -- ESP Render 块 (do ... end 封装)
    -- ============================================
    do
        ESP:Start() -- 启动 RenderStepped 循环
    end
